    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: Firestore.instance.collection("orders").snapshots(),  //represented by snapshot in return below
            ...
            return snapshot.hasData
              ...
              itemBuilder: (c, index){
                return FutureBuilder<QuerySnapshot>(
                  future: Firestore.instance    //represented by snap in return below
                      .collection("items")
