      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            ...
            child: Container(
              child: Icon(
                Icons.arrow_drop_down_circle, //SystemNavigator.pop(); is performed i.e close app
                color: Colors.white,
              ),
            ),
          ),
...
class AdminShippingDetails extends StatelessWidget {
      ...
      children: [
        ...
        Padding(
          ...
          child: Center(
            child: InkWell(
              onTap: (){
                confirmOrderShifted(context,getOrderId);
              },
              child: Container(
                decoration: new BoxDecoration(
                  gradient: new LinearGradient(
  ...
  confirmOrderShifted(BuildContext context, String mOrderId){
    ...
    Fluttertoast.showToast(msg: "Order has shipped");
