...
class _UploadPageState extends State<UploadPage> with AutomaticKeepAliveClientMixin<UploadPage>
{
  ...
  String productId = DateTime.now().millisecondsSinceEpoch.toString();//unique id pf product to store in database
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.shop_two, color:Colors.black26, size: 200.0,),
            Padding(
    ...
    return Scaffold(
      ...
      body: ListView(
        children:[
          ...
          ListTile(
            leading: Icon(Icons.create, color: Colors.pink,),
            title: Container(
              width: 250.0,
              child: TextField(
                style: TextStyle(color: Colors.grey[700]),
