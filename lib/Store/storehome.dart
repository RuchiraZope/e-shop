...
Widget sourceInfo(ItemModel model, BuildContext context,    //display each product
                ...
                children: [
                  ...
                  Container(
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(model.title, style: TextStyle(color: Colors.black, fontSize:16.0),),
                        ),
                      ],
                    ),
                  ),
