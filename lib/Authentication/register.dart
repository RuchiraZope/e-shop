  ...
  Future<void> uploadAndSaveImage() async{
    if(_imageFile==null){
      ...
      _passwordTextEditingController.text == _cPasswordTextEditingController.text
          ...
          ? uploadToStorage() : displayDialog("Please fill required details") : displayDialog("Password do not match");
    }
  }
...
displayDialog(String msg){
  ...
  uploadToStorage() async {
    ...
    String imageFileName = DateTime.now().millisecondsSinceEpoch.toString(); //name of image in database
